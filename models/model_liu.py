...
class r_net101(nn.Module):
    def __init__(self, pretrained=True, num_class=1091):
...
class Classifier(nn.Module):
    def __init__(self, num_class=1091, in_dim=2048):
...
class r_net50_val(nn.Module):
    def __init__(self, pretrained=False, num_class=1091):
        super(r_net50_val, self).__init__()
        #load the model
        # self.model = models.resnet50(pretrained=pretrained)   
        ...
        self.classifier = Classifier_val(num_class, in_dim=2048)
...
class Classifier_val(nn.Module):
    def __init__(self, num_class=1091, in_dim=2048):
        super(Classifier_val, self).__init__()
